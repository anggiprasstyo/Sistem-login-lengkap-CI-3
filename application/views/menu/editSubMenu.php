    ...
    <div class="container-fluid">
        ...
        <h1 class="h5 mb-4 text-gray-800">Ubah Submenu</h1>
                ...
                <form action="" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <a href="<?= base_url('menu/submenu'); ?>" class="btn btn-secondary float-left"><i class="fas fa-arrow-alt-circle-left"></i> Batal</a>
